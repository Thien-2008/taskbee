...
const benefits = [
  {
    ...
    desc: 'Hàng ngàn người dùng sẵn sàng nhận việc ngay khi bạn đăng. Kết quả đầu tiên có thể về trong vài giờ.',
  },
  {
    icon: TrendingUp,
    title: 'Chỉ trả cho kết quả',
    desc: 'Ngân sách được giữ an toàn. Bạn chỉ thanh toán khi công việc đạt yêu cầu và được duyệt.',
  },
  {
    icon: Shield,
    title: 'Kiểm soát chất lượng',
    desc: 'Tự đặt tiêu chí đánh giá. Hệ thống hỗ trợ duyệt kết quả và báo cáo chi tiết.',
  },
  {
    icon: BarChart3,
    title: 'Báo cáo minh bạch',
    desc: 'Theo dõi tiến độ, số lượng công việc đã hoàn thành, chi phí thực tế qua dashboard trực quan.',
  },
]
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#0a0a0b', color: '#EDEBE7', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '64px 20px 32px', textAlign: 'center' }}>
        <ScrollReveal>
          <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 'clamp(32px, 5vw, 48px)', lineHeight: 1.15, marginBottom: 16 }}>
            Giải pháp nhân lực linh hoạt cho doanh nghiệp
          </h1>
        </ScrollReveal>
        <ScrollReveal delay={0.1}>
          <p style={{ color: '#8A857D', fontSize: 16, lineHeight: 1.7, margin: 0 }}>
            Thuê người làm việc theo từng công việc nhỏ. Chỉ trả tiền khi có kết quả – không rủi ro, không ràng buộc.
          </p>
        </ScrollReveal>
      </section>
      ...
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '60px 20px' }}>
        <ScrollReveal>
          <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 'clamp(24px, 4vw, 32px)', marginBottom: 32, textAlign: 'center' }}>
            Quy trình đăng công việc đơn giản
          </h2>
        </ScrollReveal>
        {[
      ...
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '40px 20px 60px' }}>
        <ScrollReveal>
          <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 'clamp(24px, 4vw, 28px)', marginBottom: 24, textAlign: 'center' }}>
            TaskBee vs Thuê part‑time vs Agency
          </h2>
        </ScrollReveal>
