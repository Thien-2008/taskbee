    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#0a0a0b', color: '#EDEBE7', minHeight: '100vh', userSelect: 'none' }}>
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '64px 20px 80px' }}>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p style={{ color: '#8A857D', lineHeight: 1.8 }}>Thu nhập chỉ được ghi nhận sau khi công việc được duyệt. Yêu cầu rút tiền được xử lý từ Thứ 2 đến Thứ 6, trong khung giờ 8:00 – 20:00 (không bao gồm ngày lễ, Thứ 7, Chủ nhật). Tiền về tài khoản ngân hàng trong 1-2 ngày làm việc sau khi duyệt.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 20, color: '#F5A623', marginBottom: 12 }}>6. Chất lượng và vi phạm</h2>
          <p style={{ color: '#8A857D', lineHeight: 1.8 }}>Gian lận bị phát hiện sẽ bị thu hồi thu nhập liên quan và khóa tài khoản vĩnh viễn. Vi phạm nhẹ lần đầu sẽ nhận cảnh báo và hướng dẫn. Từ lần thứ 3, tài khoản có thể bị tạm khóa 7 ngày để xem xét.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 20, color: '#F5A623', marginBottom: 12 }}>7. Giới hạn trách nhiệm</h2>
          <p style={{ color: '#8A857D', lineHeight: 1.8 }}>TaskBee là nền tảng trung gian, không phải bên sử dụng lao động. Chúng tôi không đảm bảo số lượng công việc hay mức thu nhập cụ thể và không chịu trách nhiệm về thiệt hại gián tiếp do sự cố kỹ thuật.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 20, color: '#F5A623', marginBottom: 12 }}>8. Thay đổi điều khoản</h2>
          <p style={{ color: '#8A857D', lineHeight: 1.8 }}>TaskBee có thể cập nhật điều khoản. Thay đổi quan trọng sẽ được thông báo trước ít nhất 7 ngày qua email hoặc ứng dụng. Tiếp tục sử dụng sau ngày hiệu lực đồng nghĩa chấp nhận điều khoản mới.</p>
        </section>
        <section>
          <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 20, color: '#F5A623', marginBottom: 12 }}>9. Liên hệ</h2>
          <p style={{ color: '#8A857D', lineHeight: 1.8 }}>Mọi thắc mắc vui lòng gửi về: taskbee.support@gmail.com</p>
        </section>
      </main>
      <Footer />
    </div>
